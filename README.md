...
3. jQuery_Ajax_Demo00
   ...
   * Mission to be completed: 
     * Modify Index.js to encapsulate the dropDownList function so that it can be commonly used.
     * Test whether 2 or more customized dropDownLists may conflict with each other.
